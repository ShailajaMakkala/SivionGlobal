...
const About = () => {
  return (
    <>
      ...
      {/* Hero Section */}
      <div className="pt-32 pb-24 md:pt-40 md:pb-32 text-center text-white relative overflow-hidden border-b border-white/5 bg-[#0A192F]">
        {/* Darkened background image */}
        <img src="/About%20Us%20sivion.jpg" alt="About SiviOn Background" className="absolute inset-0 w-full h-full object-cover opacity-30" />
        ...
        <div className="max-w-4xl mx-auto px-4 py-12 relative z-10">
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl text-slate-200 font-light max-w-3xl mx-auto leading-relaxed"
          >
      ...
      <section className="py-24 relative overflow-hidden border-b border-white/5">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center_left,_var(--tw-gradient-stops))] from-blue-900/15 via-[#0A192F] to-[#0A192F]"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-slate-400 text-lg leading-relaxed mb-6 font-light">
              Founded in 2026, SiviOn Global Technologies started with a simple premise: enterprise software doesn't have to be slow, bloated, or ugly.
            </p>
