        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:pr-8">
            <Link to="/" className="inline-block mb-6 outline-none">
              <Logo className="h-32 max-w-[400px]" />
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-5">
              ...
              <li className="flex items-center group">
                ...
                <span className="text-sm font-medium text-slate-300">support@sivionglobaltechnologies.com<br />info@sivionglobaltechnologies.com</span>
              </li>
            </ul>
          </div>
