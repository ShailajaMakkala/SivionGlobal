          ...
          <div>
            ...
            <ul className="space-y-5">
              ...
              <li className="flex items-center group">
                ...
                <span className="text-sm font-medium text-slate-300">+91 9581136661<br /> +91 9581136662</span>
              </li>
              <li className="flex items-center group">
                ...
                <span className="text-sm font-medium text-slate-300">support@sivionglobaltechnologies.com</span>
                <span className="text-sm font-medium text-slate-300">info@sivionglobaltechnologies.com</span>
              </li>
            </ul>
          </div>
